...
CASES = [
    ...
    ([(0, 0)], (0, 0, 600, 600)),
    ([(0, 5079)], (0, 5079-600, 600, 600)),
    ([(5079, 0)], (5079-600, 0, 600, 600)),
    ([(5079, 5079)], (5079-600, 5079-600, 600, 600)),
    ...
    ([(5079, 2000), (5079, 3000)], (5079-1060, 1970, 1060, 1060)),
    ([(10, 2000), (10, 3000)], (0, 1970, 1060, 1060)),
    ([(2000, 10), (3000, 10)], (1970, 0, 1060, 1060)),
    ([(2000, 5079), (3000, 5079)], (1970, 5079-1060, 1060, 1060)),

    # corners
    ([(0, 0), (600, 600)], (0, 0, 660, 660)),
    ([(5079, 5079), (4479, 4479)], (5079-660, 5079-660, 660, 660)),
    ([(0, 5079), (600, 4479)], (0, 5079-660, 660, 660)),
    ([(5079, 0), (4479, 600)], (5079-660, 0, 660, 660)),
